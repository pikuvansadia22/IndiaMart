...
exports.getShopingCartData = async function (req, res) {
  ...
  res.render('shoping-cart', { title_page:"cart",products: productdetails, user_id: session.user_id, firstname: session.firstname, lastname: session.lastname, email: session.email })
}
